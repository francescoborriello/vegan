 ...
 * up to version 1616777801.
 * Generated on 2021-03-26 16:56:41 by root
 */
class PropelMigration_1616777801
{
    public $comment = '';
...
ALTER TABLE `images`
  ...
  ADD `filename` VARCHAR(255) NOT NULL AFTER `id`,

  ADD `path` VARCHAR(255) NOT NULL AFTER `filename`,

  ADD `size` FLOAT NOT NULL AFTER `path`,
