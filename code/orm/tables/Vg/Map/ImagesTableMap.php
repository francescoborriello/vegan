...
class ImagesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Vg.Map.ImagesTableMap';
     ...
     */
    const OM_CLASS = '\\Vg\\Images';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Vg.Images';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Path', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'path', 'createdAt', ),
        self::TYPE_COLNAME       => array(ImagesTableMap::COL_ID, ImagesTableMap::COL_NAME, ImagesTableMap::COL_PATH, ImagesTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'path', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Path' => 2, 'CreatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'path' => 2, 'createdAt' => 3, ),
        self::TYPE_COLNAME       => array(ImagesTableMap::COL_ID => 0, ImagesTableMap::COL_NAME => 1, ImagesTableMap::COL_PATH => 2, ImagesTableMap::COL_CREATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'path' => 2, 'created_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'createdAt' => 'CREATED_AT',
        'images.createdAt' => 'CREATED_AT',
        'ImagesTableMap::COL_CREATED_AT' => 'CREATED_AT',
    ...
    public function initialize()
    {
        ...
        $this->addColumn('created_at', 'CreatedAt', 'VARCHAR', true, 128, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ImagesTableMap::COL_ID);
            $criteria->addSelectColumn(ImagesTableMap::COL_NAME);
            $criteria->addSelectColumn(ImagesTableMap::COL_PATH);
            $criteria->addSelectColumn(ImagesTableMap::COL_CREATED_AT);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ImagesTableMap::COL_ID);
            $criteria->removeSelectColumn(ImagesTableMap::COL_NAME);
            $criteria->removeSelectColumn(ImagesTableMap::COL_PATH);
            $criteria->removeSelectColumn(ImagesTableMap::COL_CREATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Vg\Images) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ImagesTableMap::DATABASE_NAME);
            $criteria->add(ImagesTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ImagesTableMap::COL_ID) && $criteria->keyContainsValue(ImagesTableMap::COL_ID) ) {
